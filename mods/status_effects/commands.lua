...
jutil.cmd.register("effect",
	{
		...
		apply = jutil.cmd.command({"effect:string", "duration:number", "player:?string"},
		function(player_name, effect_name, duration, given_player_name)
			...
			return status_effect.apply_effect(effect_name, player, duration);
